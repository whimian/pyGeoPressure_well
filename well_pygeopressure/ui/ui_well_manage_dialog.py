...
class Ui_well_manage_Dialog(object):
    def setupUi(self, well_manage_Dialog):
        ...
        well_manage_Dialog.resize(595, 569)
        icon = QtGui.QIcon()
        ...
        self.edit_well_Button = QtGui.QPushButton(self.groupBox)
        self.edit_well_Button.setGeometry(QtCore.QRect(0, 160, 25, 25))
        self.edit_well_Button.setText(_fromUtf8(""))
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/edit_icon")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.edit_well_Button.setIcon(icon6)
        self.edit_well_Button.setIconSize(QtCore.QSize(20, 20))
        self.edit_well_Button.setFlat(True)
        self.edit_well_Button.setObjectName(_fromUtf8("edit_well_Button"))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/view_icon")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.view_log_Button.setIcon(icon7)
    ...
    def retranslateUi(self, well_manage_Dialog):
        ...
        self.edit_well_Button.setToolTip(_translate("well_manage_Dialog", "Edit Well Info", None))
